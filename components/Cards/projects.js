...
export const projectsData = [
  {
    title: 'Taskify',
    description: `Simple responsive, drag and drop To-Do App built with React TypeScript, to practice implementation of TS with React. Different libraries/hooks of useState, useEffect, useRef, react-beautiful-dnd and React-icons are used to build the features.`,
